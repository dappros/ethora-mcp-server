...
const AUTHENTICATED_COMMON = [
  ...
  "Website chat widget: `ethora-agents-activate-v2 { agentId, chatJid }` after inviting the agent, then `ethora-widget-embed-snippet` for the <script> tag (`ethora-help { goal: \"widget\" }` lists the steps).",
